...
////VALIDAÇÃO DO ID
if(!isset($_GET['id'])){
    header('location: contutor.php?status=error');
    exit;
}
//CONSULTA O SERVICO
$obTutor = Tutor::getTutores($_GET['id']);
//var_dump($obServico);
//exit();
...
if(isset($_POST['excluir'])){
    ...
    header('location: contutor.php?status=success');
    exit;
}
                ...
                <div class="card shadow mb-4 mt-5">
                    <div class="card-header py-3">
                        ...
                        <div class="row">
                            <div class="col">
                                <br>
                                <h6 class="m-0 font-weight-bold text-danger">Tem certeza de que deseja excluir o tutor abaixo?</h6>
                            </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table  id="myList" class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <?php if ($obTutor !== null) : ?>
                                    <tr>
                                        <td><?= $obTutor->id?></td>
                                        <td><?= $obTutor->status ?></td>
                                        <td><?= $obTutor->cpf_pessoa  ?></td>
                                        <td><?= $obTutor->dtregistro ?></td>
                                    </tr>
                                <?php else : ?>
                                    <tr>
                                        <td colspan="7">Nenhum tutor foi encontrado com o ID fornecido.</td>
                                    </tr>
                            ...
                            <a href="contutor.php"><button type="button" class= "btn btn-primary btn-sm-2">Voltar</button></a>
                            </form>
                        </div>

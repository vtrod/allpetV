                                            ...
                                            <table  id="myList" class="table table-bordered" width="100%" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 180px">
                                                        <a href="editarpet.php?id=<?= $pets->id ?>"><button type="button" name="editar" class= "btn btn-primary btn-sm-2">Editar</button>
                                                        </a>
                                                        <a href="excluirpet.php?id=<?= $pets->id ?>"><button type="button" name="excluir" class= "btn btn-danger btn-sm-2">Excluir</button>
                                                        </a>
                                                    </td>
                                                </tr>
                                                <?php endforeach; ?>

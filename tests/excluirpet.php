                ...
                <div class="card shadow mb-4 mt-5">
                    <div class="card-header py-3">
                        ...
                        <div class="row">
                            ...
                            <div class="">
                                <br>
                                <h6 class="m-0 font-weight-bold text-danger">Tem certeza de que deseja excluir o pet abaixo?</h6>
                            </div>
                            <div class="col-auto">
                                <form class="form-inline">
                                    ...
                                    <a href="./addpet.php" class="btn btn-primary ml-1" title="Cadastrar">
                                    ...
                                    <div class="table-responsive">
                                        <table id="myList" class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <?php if ($obPet !== null) : ?>
                                                <tr>
                                                    <td><?= $obPet->id ?></td>
                                                    <td><?= $obPet->pet_nome ?></td>
                                                    <td><?= $obPet->especie ?></td>
                                                    <td><?= $obPet->raca ?></td>
                                                    <td><?= $obPet->pelagem ?></td>
                                                    <td><?= $obPet->sexo ?></td>
                                                    <td><?= $obPet->observacoes ?></td>


                                                </tr>
                                            <?php else : ?>
                                                <tr>
                                                    <td colspan="7">Nenhum pet encontrado com o ID fornecido.</td>
                                                </tr>
                                        ...
                                        <a href="conpet.php"><button type="button" class= "btn btn-primary btn-sm-2">Voltar</button></a>
                                </form>
                            </div>
                            <!----------------->
